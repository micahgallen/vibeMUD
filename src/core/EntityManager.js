...
class EntityManager {
  ...
  loadAll() {
    ...
    const locations = [
      ...
      { base: path.join(__dirname, '../world/hill_valley/1955'), types: ['items', 'containers', 'rooms', 'npcs'] }, // Hill Valley 1955
      { base: path.join(__dirname, '../world/hill_valley/1985'), types: ['items', 'containers', 'rooms', 'npcs'] }, // Hill Valley 1985
      { base: path.join(__dirname, '../world/hill_valley/1985alt'), types: ['items', 'containers', 'rooms', 'npcs'] }, // Hill Valley 1985alt
      { base: path.join(__dirname, '../world/hill_valley/2015'), types: ['items', 'containers', 'rooms', 'npcs'] } // Hill Valley 2015
    ];
